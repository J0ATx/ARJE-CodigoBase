...
GRANT SELECT ON lostrestanosdb.Cliente TO 'gerente'@'localhost';
...
GRANT SELECT ON lostrestanosdb.Cantidad_Clientes TO 'gerente'@'localhost';
GRANT SELECT ON lostrestanosdb.Cantidad_Personal TO 'gerente'@'localhost';
GRANT SELECT ON lostrestanosdb.Ingresos_Totales TO 'gerente'@'localhost';
GRANT SELECT ON lostrestanosdb.Ingresos_Por_Cliente TO 'gerente'@'localhost';
GRANT SELECT ON lostrestanosdb.Ingresos_Por_Camarero TO 'gerente'@'localhost';
GRANT SELECT ON lostrestanosdb.Ingresos_Por_Producto TO 'gerente'@'localhost';
GRANT SELECT ON lostrestanosdb.Ingresos_Por_Pago TO 'gerente'@'localhost';
GRANT SELECT ON lostrestanosdb.Ingresos_Por_Fecha TO 'gerente'@'localhost';
GRANT SELECT ON lostrestanosdb.No_Show_Por_Cliente TO 'gerente'@'localhost';
GRANT SELECT ON lostrestanosdb.No_Show_Por_fecha TO 'gerente'@'localhost';
GRANT SELECT ON lostrestanosdb.Ventas_Por_Producto TO 'gerente'@'localhost';
...
GRANT SELECT ON lostrestanosdb.Stock TO 'cliente_registrado'@'localhost';
GRANT SELECT ON lostrestanosdb.Stock_Cantidad TO 'cliente_registrado'@'localhost';
GRANT SELECT ON lostrestanosdb.Consume TO 'cliente_registrado'@'localhost';
...
GRANT SELECT, INSERT, UPDATE, DELETE ON lostrestanosdb.Pedido TO 'cliente_registrado'@'localhost';
GRANT SELECT, INSERT, UPDATE, DELETE ON lostrestanosdb.Contiene TO 'cliente_registrado'@'localhost';
GRANT SELECT, INSERT, UPDATE, DELETE ON lostrestanosdb.Efectua TO 'cliente_registrado'@'localhost';
