...
GRANT SELECT, UPDATE ON lostrestanosdb.Cliente TO 'cliente_registrado'@'localhost';
GRANT SELECT ON lostrestanosdb.Personal TO 'cliente_registrado'@'localhost';
