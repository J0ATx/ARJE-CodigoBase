...
try {
    ...
    $mail->Username   = 'lostrestanospizzeria@gmail.com';            // Nombre de usuario SMTP (tu dirección de correo)
    $mail->Password   = 'los3tanos2000';     // Contraseña de tu correo (o contraseña de aplicación)
    ...
    $mail->setFrom('lostrestanospizzeria@gmail.com', 'Tu Aplicación Web');
    $mail->addAddress('nahueirasbotto@destino.com', 'Nahuel');    // Agregar destinatario
